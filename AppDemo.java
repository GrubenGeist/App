...
// Annäherung an den Spieler priorisieren
    ...
    public static void bewegeSpieler(Point spielerPosition) throws InterruptedException {
        KeyListener listener = new KeyListener() {
            @Override
            public void keyTyped(KeyEvent push) {
            }

            @Override
            public void keyPressed(KeyEvent push) {
                switch (push.getKeyCode()) {
                    case KeyEvent.VK_UP:
            ...
            @Override
            public void keyReleased(KeyEvent push) {
            }
        };

        // Spielfeld aktualisieren
        // ... (Code zum Aktualisieren des Spielfelds mit den neuen Positionen)
        // Warte, bevor der nächste Spielschritt ausgeführt wird
        Thread.sleep(1600);
    }
